...
import safeImg from "../assets/pill.jpg";
...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className={`w-full lg:w-1/2 flex items-center justify-center bg-white ${wobble ? "animate-wobble" : ""}`}>
        <div className="w-[90%] max-w-md">
          ...
          <button
            ...
            className="w-full bg-blue-600 text-white py-3 rounded-xl mt-4 hover:scale-105 transition"
          >
            Continue
          </button>
      ...
      {/* RIGHT */}
      <div className="hidden lg:flex w-1/2 items-center justify-center bg-gradient-to-r from-blue-100 to-blue-300">
